...
const productos = [
    ...
    {id: '8', category:'ipa', title: 'Delirium Argentum', description: 'Creada por primera vez para la celebración del 25º aniversario de Delirium Tremens. Elaborada con tres tipos de levadura y cinco tipos de maltas distintas.', price: 380, pictureURL: ipaArgentum, stock: 23},
    {id: '9', category:'ipa', title: 'Cerdo Voladores', description: 'Cerdo VoladoresSpencer Trappist IPA se inspira en la tradición cervecera de la Costa Oeste, pero dándole el toque tradicional belga a esta cerveza muy aromática.', price: 430, pictureURL: ipaVoladores, stock: 'sin stock'},
    ...
    {id: '13',category:'stout', title: 'Organic Chocolate', description: 'Lanzada al mercado en el 2012, esta Stout elaborada con ingredientes organicos, destaca por la presencia del cacao que domina el conjunto.', price: 570, pictureURL: stoutOrganicChoco, stock: 37},
